import numpy as np
from sub_solverInverse_Lrond_target3 import sub_solverInverse_Lrond_target3

def sub_solverInverse_Verlet_target3(nu,n_d,M0transient,Deltar,f0,MatReta_d,MatRa,MatRg,shss,sh,
    ...
    #  Function name: sub_solverInverse_Verlet_target3
    ...
    for k in range(M0transient):
        ...
        MatRLrond1s2 = sub_solverInverse_Lrond_target3(nu,n_d,MatReta_d,MatRa,MatRg,MatRZ1s2,shss,sh,Rlambda_iter)
