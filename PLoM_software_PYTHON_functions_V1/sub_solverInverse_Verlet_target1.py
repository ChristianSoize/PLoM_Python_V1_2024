import numpy as np
from sub_solverInverse_Lrond_target1 import sub_solverInverse_Lrond_target1

def sub_solverInverse_Verlet_target1(nu,n_d,M0transient,Deltar,f0,MatReta_d,MatRa,MatRg,shss,sh,
                                     ArrayWiennerM0transient_ell,MatRGauss_ell,Rlambda_iter,coNr,coNr2,MatReta_targ):
    #------------------------------------------------------------------------------------------------------------------------------------------
    #
    #  Copyright: Christian Soize, Universite Gustave Eiffel, 08 June 2024
    #
    #  Software     : Probabilistic Learning on Manifolds (PLoM) 
    #  Function name: sub_solverInverse_Verlet_target1
    ...
    for k in range(M0transient):
        ...
        MatRLrond1s2 = sub_solverInverse_Lrond_target1(nu,n_d,MatReta_d,MatRa,MatRg,MatRZ1s2,shss,sh,Rlambda_iter, 
