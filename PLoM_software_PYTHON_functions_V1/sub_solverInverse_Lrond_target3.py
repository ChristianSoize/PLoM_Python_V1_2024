...
def sub_solverInverse_Lrond_target3(nu, n_d, MatReta_d, MatRa, MatRg, MatRZ, shss, sh, Rlambda_iter):
    #------------------------------------------------------------------------------------------------------------------------------------------
    #
    ...
    for ell in range(n_d):
        ...
        MatRLc[:,ell] = - (Rlambda_iter[0:nu] + 2*Rlambda_iter[nu:2*nu]*RU)  # MatRLc(nu,n_d),Rlambda_iter(mhc), RU(nu)
