...
def mainWorkflow_Data_generation2():
    ...
    if indv73 == 1: # Case of a matlab file.mat saved with -v7.3 option         
        with h5py.File('FileMatRxxTarget2', 'r') as file:     # Load FileMatRxxTarget2 from a file.mat saved with -v7.3 option 
            Rmeanxx_targ_data = data['Rmeanxx_targ_data'][:].T

    if indv73 == 2: # Case of a matlab file.mat saved without using -v7.3 option 
        data = scipy.io.loadmat('FileMatRxxTarget2')          # Load FileMatRxxTarget2 from a file.mat saved without using -v7.3 option   
    ...
    #--- ind_type_targ = 2: target defined by giving the target mean value of unscaled XX_targ 
    Rmeanxx_targ   = Rmeanxx_targ_data[Indx_targ-1]  # Rmeanxx_targ(nx_targ): nx_targ components of mean value E{XX_targ} 
